...
const SideBar: FC = () => {
  ...
  const [isBeeSweeperOpened, setIsBeeSweeperOpened] = useState(false);
  ...
  return (
    <>
      ...
      >
        <div className="border-dark-lighten flex h-20 items-center justify-between border-b px-6">
          <Link to="/" className="flex items-center gap-1">
            ...
            <h1 className="text-xl">SocialHive</h1>
          </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={() => {
                setIsBeeSweeperOpened(true)
                initGame()
              }}
              // className="flex items-center justify-between bg-dark-lighten h-8 w-8 rounded-full"
            >

              <img className="h-6 w-6" src="/beesweeper.svg" alt="" />
            </button>
      ...
      {createConversationOpened && (
        ...
        <BeeSweeper isOpened={isBeeSweeperOpened} setIsOpened={setIsBeeSweeperOpened} />
